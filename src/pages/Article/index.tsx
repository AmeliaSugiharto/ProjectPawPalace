      ...
      <View style={styles.contentContainer2}>
        <View style={styles.containerBox2}>
          <View style={styles.textPlaceholder1}>
            <Text style={styles.placeholderText1}>Memilih Hewan Peliharaan yang Tepat : Kucing atau Anjing</Text>
          </View>
        </View>
        <View>
      ...
      <View style={styles.contentContainer3}>
        <View style={styles.containerBox3}>
          <View style={styles.textPlaceholder2}>
            <Text style={styles.placeholderText2}>Memelihara Kucing atau Anjing baik bagi Kesehatan Otak </Text>
          </View>
        </View>
